...
<html class="fixed sidebar-left-collapsed">
	<head>  
		<meta charset="UTF-8"> 
		<link rel="shortcut icon" href="<?php echo base_url()?>/assets/images/apotek.png" type="image/ico">   
		<title>Apotek Cipta Sehat</title>    
	...
	<body class="bgbody">
                    ...
                    <section class="panel">
                        <header class="panel-heading">    
                            <div class="row show-grid">
                                <div class="col-md-6" align="left"><h2 class="panel-title">Data Jenis Pembayaran</h2></div>
                                <?php  
                                echo level_user('penjualan','jenispembayaran',$this->session->userdata('kategori'),'add') > 0 ? '<div class="col-md-6" align="right"><a class="btn btn-success" href="#"  data-toggle="modal" data-target="#tambahData"><i class="fa fa-plus"></i> Tambah</a></div>':'';
                                ?> 
							</div>
                        </header>
                        <div class="panel-body"> 
                                <table class="table table-bordered table-hover table-striped" id="bankdata">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Kategori</th>
        ...
        <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">
                    <?php echo form_open('penjualan/banktambah',' id="FormulirTambah"');?>  
                    <header class="panel-heading">
                        <h2 class="panel-title">Tambah Jenis Pembayaran</h2>
                    </header>
                    <div class="panel-body">
                            <div class="form-group mt-lg singkatan">
                                <label class="col-sm-3 control-label">Singkatan Nama Bank<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="singkatan" class="form-control" required/>
                                </div>
                            </div> 
                            <div class="form-group mt-lg nama_bank">
        ...
        <div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                <section class="panel  panel-primary">
                    <?php echo form_open('penjualan/bankedit',' id="FormulirEdit"');?>  
                    <input type="hidden" name="idd" id="idd">
                    <header class="panel-heading">
                        <h2 class="panel-title">Edit Jenis Pembayaran</h2>
                    </header>
                    <div class="panel-body">
                            <div class="form-group mt-lg singkatan">
                                <label class="col-sm-3 control-label">Singkatan Nama Bank<span class="required">*</span></label>
                            ...
                            <div class="form-group mt-lg jenis">
                                <label class="col-sm-3 control-label">Kategori<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <select data-plugin-selectTwo class="form-control"  id="jenis"  name="jenis" required>  
                                        <option value="credit card">credit card</option>
                                        <option value="debet">debet</option>
                                    </select> 
                                </div>
            ...
            <div class="modal-dialog">
                ...
                <section class="panel  panel-danger">
                    ...
                    <footer class="panel-footer"> 
                        <div class="row">
                            <div class="col-md-12 text-right"> 
                                <?php echo form_open('penjualan/bankhapus',' id="FormulirHapus"');?>  
		...
		<script type="text/javascript"> 
            var tablebank = $('#bankdata').DataTable({  
                "serverSide": true, 
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url()?>penjualan/databank",
                    "type": "GET"
                }, 
                "columnDefs": [
                    { 
            ...
            function edit(elem){
                ...
                $.ajax({
                    type: 'GET',
                    url: '<?php echo base_url()?>penjualan/bankdetail',
                    data: 'id=' + dataId,
                    dataType 	: 'json',
                    success: function(response) {  
                        $.each(response, function(i, item) { 
                        document.getElementById("singkatan").setAttribute('value', item.singkatan);
                        document.getElementById("nama_bank").setAttribute('value', item.nama_bank); 
