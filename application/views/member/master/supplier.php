            ...
            <div class="modal-dialog">
                ...
                <section class="panel  panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group mt-lg kontak_person">
                                <label class="col-sm-3 control-label">Kontak person<span class="required">*</span></label>
                                <div class="col-sm-9">
                ...
                <section class="panel  panel-primary">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group mt-lg kontak_person">
                                <label class="col-sm-3 control-label">Kontak person<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <input type="text" name="kontak_person" id="kontak_person" class="form-control" required/>
                                </div>
                            </div> 
                            <div class="form-group telepon">
                                <label class="col-sm-3 control-label">Telepon</label>
            ...
            function edit(elem){
                ...
                $.ajax({
                    ...
                    success: function(response) {  
                        ...
                        document.getElementById("kontak_person").setAttribute('value', item.kontak_person); 
